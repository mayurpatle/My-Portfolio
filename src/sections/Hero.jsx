...
export default function Hero() {
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden">
      {/* Background grid + radial glow — kept once each */}
      ...
      {/* Foreground content — tightened pt/pb so everything fits at 100% zoom */}
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-between px-6 pt-20 pb-8 lg:px-12">
        ...
        <div className="max-w-5xl">
          ...
          {/* Inline fluid font-size — tighter than display-xl, fits in viewport at 100% */}
          <h1
          ...
          >
            <Magnetic>
              <a
                href="#projects"
                className="group relative inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 text-sm font-medium text-ink-950 transition-colors hover:bg-neon-cyan"
              >
                View Selected Work
        ...
        <motion.div
          ...
          className="mt-8 flex items-center justify-between text-xs font-mono text-white/40"
        >
          <span>[ 01 / HERO ]</span>
